...
net_bp = BaseNet_GradientTest_BP()
net_fa = BaseNet_GradientTest_FA()
net_ifa = BaseNet_GradientTest_IFA()
...
if args.resume:
    ...
    net_bp.load_state_dict(checkpoint['net'])
...
for epoch in range(start_epoch, start_epoch+200):
    ...
    print('IFA gradient ratios: {0:.3f} {1:.3f} {2:.3f} {3:.3f} {4:.3f} {5:.3f} {6:.3f}'.format(*grad_ratios_ifa.mean(0)))
    test(epoch)
#%%
